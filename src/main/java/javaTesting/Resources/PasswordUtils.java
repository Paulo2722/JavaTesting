...
public class PasswordUtils {
    ...
    private static final String ALPHABET = "0123456789ABCDEFG";  //aixó hauria de ser més complexe
    ...
    public static String hashedPassword(String password, String salt) {
        ...
        try {
            ...
            result = new String (md.digest()); //(md.digest()).toString();//new String (md.digest());
